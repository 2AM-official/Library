...
public class UserInterface {
                ...
                if(!(input.contains("+"))) {                                                                           
                    ...
                    while(iter2.hasNext()) {
                        ...
                        if(deletebook.getISBN().equals(iSBNcheck)) {                                           
                            ...
                            if(!(deletebook.getNumBook() == deletebook.getNumBookAva())){             
                                int countnum = deletebook.getNumBook() - deletebook.getNumBookAva();
	...
	public static void outputBook(Book b) {
		f.format("%-15s %-15s %-15s %-10s %-15d %-15d ", b.getISBN(), b.getTitle(), b.getAuthor(), b.getCategory(), b.getNumBook(), b.getNumBookAva());
		System.out.println(" ");
	}
			...
			while(iter2.hasNext()) {
				...
				if(updatebook.getISBN().equals(updateISBN)) {
					...
					if(checkLetter.equalsIgnoreCase("TC")) {
						...
						System.out.println("Book "+updateISBN+"'s total_copy_number has been updated from "+updatebook.getNumBook()+" to "+updateTC+" successfully.");
						updatebook.setNumBook(updateTC);;
					}
					if(checkLetter.equalsIgnoreCase("AC")) {
                        ...
                        while(updateAC>updatebook.getNumBook()){                                                           
                            System.out.println(" ");
						...
						System.out.println("Book "+updateISBN+"'s available_copy_number has been updated from "+updatebook.getNumBookAva()+" to "+updateAC+" successfully.");
						updatebook.setNumBookAva(updateAC);;
					}
				}
			}
        ...
        * */
        Comparator <Book> comparator = new Comparator<Book>() {
            ...
            public int compare(Book book1, Book book2) {
                if (book1.getNumBook() > book2.getNumBook()) {
                    return -1;  
                } else if (book1.getNumBook() < book2.getNumBook()) {
                    return 1;  
                } else {
                    return 0;  
                }
